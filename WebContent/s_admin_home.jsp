...
<body style="background-color: lightgrey">
	...
	<div class="bckimg"
		style="height: 200px; justify-content: left; align-content: left;">
		<h3>
			Welcome Sub-Admin
		...
		<div class="c2" style="height: auto;">
			<div class="btn-row">
				...
				<form action="psEmpListForSubAdmin" method="post">
					<input type="hidden" value="<%=session.getAttribute("userEmail")%>"
						name="userEmail" placeholder="Show Employee List">
			...
			<div class="btn-row">
				...
				<form action="newFirForm" method="post">
					<input type="hidden" value="<%=session.getAttribute("userEmail")%>" name="userEmail" placeholder="Show Fir List">
					<button type="submit">FIR List</button>
				</form>
			</div>
		</div>
	</div>
	...
	<div class="c3" style="height: auto;">
		<div class="emplist" style="display: grid; justify-content: center; align-content: center; margin: 103x; padding-right: 600px;">

			<table class="table table-hover" style="width: 800px;height: 200px" border="1">
